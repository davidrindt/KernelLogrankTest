...
x = gastric.V3.values
x = x[:, None]
print(wild_bootstrap_test_logrank_covariates(x, z, d, kernel_x='gau', kernel_z='gau', seed=1, num_bootstrap_statistics = 1000000, fast_computation = True))
print(wild_bootstrap_test_logrank_covariates(x, z, d, kernel_x='gau', kernel_z='con', seed=1, num_bootstrap_statistics = 1000000, fast_computation = True))
